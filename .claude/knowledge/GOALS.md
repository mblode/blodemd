...
**G1.** What does Carol look like in the wild — is the hypothesized git-native MDX writer the person who actually shows up, or is it the founder talking to himself?

**G2.** What does she use for docs today, and why that instead of the alternatives (including doing nothing / Docusaurus / Mintlify Starter / GitBook)?
...
**G6.** What words does she use for this job, so the homepage is not speaking founder-dialect?

Each goal maps to a decision: G1 keep or rewrite Carol; G2 named enemy; G3 whether E1–E5 can go on the page; G4 price; G5 whether V1 is a voter; G6 copy.
