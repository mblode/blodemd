...
- [Edda](https://blode.co/edda): Knowledge docs for agents. Git-native MDX. Publish on merge. Sites ship `llms.txt` / `llms-full.txt` / `.md` alternates from the same deploy. See [pricing](https://blode.md/pricing).
