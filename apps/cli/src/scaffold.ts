...
const claudeInstructions = [
  ...
  "## About this project",
  "",
  "- This is a documentation site built on [Edda](https://blode.co/edda)",
  "- Pages are MDX files with YAML frontmatter",
  "- Configuration lives in `docs.json`",
  "- Run `edda dev` to preview locally",
  "- Run `edda validate` before publishing",
  "- Run `edda push` to deploy",
  "",
  "## Terminology",
  "",
  ...
  return [
    ...
    },
    {
      content: [
        ...
        "- Update this page, then preview locally with `edda dev`.",
        "",
        "## Included pages",
        "",
    ...
    },
    {
      content: [
        ...
        "5. Run `edda dev` to preview locally.",
        "6. Run `edda push` when you are ready to publish.",
        "",
      ].join("\n"),
      path: "quickstart.mdx",
    },
    ...
    },
    {
      content: [
        ...
        "",
        "This directory was scaffolded with `edda new --template starter`.",
        "",
        "## What is included",
        "",
