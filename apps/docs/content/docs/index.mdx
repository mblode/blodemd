---
title: Introduction
description: "Edda: git-native docs, published on merge. Write MDX in the repo, review it in the pull request, and the merge publishes the site."
---

Edda publishes git-native docs on merge. Write MDX in the repo, review it in the pull request, and the merge publishes the site. Navigation and branding live in a single `docs.json` file, and `edda push` deploys the same content from the CLI or CI.
