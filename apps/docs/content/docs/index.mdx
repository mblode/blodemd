---
title: Introduction
description: Blode.md is a docs-as-code platform: write MDX in your repo, configure navigation in docs.json, and deploy hosted documentation with blodemd push.
---
