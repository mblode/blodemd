...
description: Configure logo, favicon, and appearance settings in docs.json, including separate light and dark assets and supported branding options for your site.
---
