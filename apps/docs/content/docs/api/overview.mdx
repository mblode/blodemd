...
description: Use the Blode.md REST API for programmatic access to projects, deployments, and domains when you need custom tooling beyond the CLI workflows.
---
