---
title: Columns
description: Arrange Cards and other content in responsive Columns that stack on small screens and expand into multi-column layouts on larger viewports.
---
