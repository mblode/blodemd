---
title: Expandable
description: Hide nested properties, optional fields, and advanced options behind Expandable sections so reference docs stay readable without losing detail.
---
