---
title: How it works
description: See how local MDX, the edda CLI, Hono API, Vercel Blob storage, and the Next.js renderer work together when you push documentation.
---

Edda turns local MDX files into a hosted documentation site. Here is how the pieces fit together.
...
─────────       ─────────       ─────────         ───────────────
 docs/    ───►  edda   ───►  Hono API   ───►   Next.js app
