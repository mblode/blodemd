---
title: Quickstart
description: Install the Blode.md CLI, authenticate with GitHub, scaffold a docs project with blodemd new, preview locally, and deploy live docs in minutes.
---
...
with `docs.json` (scaffold it with `blodemd new docs`, then commit). In the
dashboard, open your project → **Git**, install the Blode.md GitHub App, and
