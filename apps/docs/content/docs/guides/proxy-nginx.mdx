...
description: Add Nginx location blocks to reverse-proxy /docs and /_docs on your domain to a Blode.md site while keeping the rest of your site on your server.
---
...
`proxy_no_cache` requests whose `Accept` contains `text/markdown`). Blode.md
