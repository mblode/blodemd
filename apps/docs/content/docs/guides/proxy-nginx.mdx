...
description: Add Nginx location blocks to reverse-proxy /docs and /_docs on your domain to an Edda site while keeping the rest of your site on your server.
---
