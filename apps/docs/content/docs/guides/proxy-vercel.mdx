...
description: Host Blode.md docs at yourdomain.com/docs by adding rewrites for /docs and /_docs to your Next.js next.config.js on an existing Vercel marketing site.
---
...
- **Agents get HTML when they ask for Markdown**: Blode.md answers
