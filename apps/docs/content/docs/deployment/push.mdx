...
description: Deploy your MDX docs to Edda with edda push, including project slug resolution, API key auth, directory options, and what happens during upload.
---
