...
description: Run blodemd dev to preview your documentation locally at localhost with hot reload, matching the deployed site as you edit MDX and docs.json.
---
