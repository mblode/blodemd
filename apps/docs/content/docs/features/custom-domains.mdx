...
description: Point a custom domain or subdomain at your Blode.md docs site, configure DNS with CNAME records, and add the domain in your project dashboard.
---
