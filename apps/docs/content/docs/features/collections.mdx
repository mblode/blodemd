---
title: Content types
description: Define collections in docs.json to publish blogs, courses, changelogs, and other content types alongside your main documentation with separate URLs.
---

Edda supports more than just documentation. You can publish blogs, courses, product pages, and other content types by defining collections in your configuration. Each collection has its own content directory, URL prefix, and navigation structure.
