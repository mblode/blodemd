...
description: What every Edda deploy publishes for AI agents (llms.txt, per-page Markdown, discovery headers, WebMCP tools) and what to write so agents find the right page.
---
