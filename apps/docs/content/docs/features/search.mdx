...
sidebarTitle: Search
description: Blode.md indexes titles, headings, and body text on deploy so visitors get built-in full-text search with keyboard shortcuts and no extra setup.
---
