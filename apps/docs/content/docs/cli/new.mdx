---
title: blodemd new
description: Scaffold a new Blode.md docs site with docs.json and an index.mdx starter page, either in the current folder or a docs subdirectory.
---
...
- [blodemd dev](/cli/dev) -- preview the scaffold locally
- [blodemd validate](/cli/validate) -- check docs.json after edits
