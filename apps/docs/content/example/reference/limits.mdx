...
The platform follows Vercel's multi-tenant limits and feature availability. Use this page to understand which Vercel plan requirements affect deployments.
...
- The platform resolves tenant-prefixed preview hosts, but the publish API currently creates production deployments only.
